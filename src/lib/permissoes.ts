...
export type PermissaoChave = "inicio" | "atletas" | "registrar" | "eventos" | "noticias" | "financeiro";
...
export const PERFIS_RAPIDOS: Record<string, { label: string; permissoes: PermissaoChave[] }> = {
  ...
  pontuacao: { label: "Comitê Pontuação", permissoes: ["inicio", "registrar"] },
  financeiro: { label: "Comitê Financeiro", permissoes: ["inicio", "financeiro"] },
  gestao: { label: "Comitê Gestão", permissoes: ["inicio", "atletas"] },
  geral: {
    label: "Comitê Geral",
    permissoes: ["inicio", "atletas", "registrar", "eventos", "noticias", "financeiro"],
  },
};

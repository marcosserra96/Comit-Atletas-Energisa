...
export function RejectRequestModal({
  ...
  return (
    <Modal
      ...
      description={`Informe o motivo da recusa do acesso de ${nome}. Essa justificativa fica registrada na auditoria.`}
    >
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <textarea
          ...
          minLength={5}
          rows={3}
          placeholder="Ex: e-mail fora do domínio da empresa"
